...
namespace BrewHelper.Controllers
{
    ...
    public class IngredientsController : ControllerBase
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var ingredients = await ingredientModel.GetByPageAsync(urlQueryParameters.Limit, urlQueryParameters.Page, urlQueryParameters.Name, urlQueryParameters.Id, urlQueryParameters.Types, cancellationToken);
    ...
    public record UrlQueryParameters(int Limit = 50, int Page = 1, string Name = null, long[] Id = null, Ingredient.IngredientType[] Types = null);
}
